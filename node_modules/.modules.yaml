...
hoistedDependencies:
  ...
  /cookiejar/2.1.4:
    cookiejar: private
  /cosmiconfig-typescript-loader/4.3.0(@types/node@20.3.0)(cosmiconfig@8.2.0)(ts-node@10.9.1)(typescript@5.1.3):
  ...
  /ts-node/10.9.1(@types/node@20.3.0)(typescript@5.1.3):
    ts-node: private
...
pendingBuilds: []
prunedAt: Sat, 10 Jun 2023 23:23:21 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
